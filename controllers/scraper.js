     ...
     try {
       ...
       async function collectStep() {
        try {
          ...
          const statesLength = Array.from(Array(52).keys());
          ...
          if (errorEl != undefined) {
            ...
            await page.waitForSelector('.results-parameters');
            ...
            for (let j=0;j<pageArray.length;j++) {
                ...
                for (const link of urlLinks) {
                    ...
                    const agency = {name: '',address: '', phone: '', email: '', website: '', agents: '', ['Main Office']: '', ['Other Office Locations']: '',  carriers: '', Owner: '', Role: '', Memberships: ''};
                    ...
                    if (rows) {
                        for (let i = 0; i < rows.length; i++) {
                            ...
                            if (rowHTML) {
                                if (rowHTML.includes('<h4>Independent Agents</h4>')) {
