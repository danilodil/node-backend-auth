/* eslint-disable max-len, consistent-return, no-restricted-syntax,camelcase */
...
module.exports = {
  createApplicant: async (req, res, next) => {
    try {
      ...
      const bodyData = { body: newResponse, url, validations: (validations && validations.length > 0) ? validations : null };
      req.session.data = {
