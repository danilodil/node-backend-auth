  ...
  createContact: async (req, res, next) => {
    try {
      ...
      if (req.body.runBoth) {
        ...
        const jsonresponse = JSON.parse(convert.xml2json(response, {compact: true, spaces: 0}));
        if (jsonresponse.LeadResponseResult.Result._text !== 'OK' || jsonresponse.LeadResponseResult.ErrorCode._text !== '0') {
          throw {
            errorCode: jsonresponse.LeadResponseResult.ErrorCode._text,
            description: jsonresponse.LeadResponseResult.ErrorDescription._text
          };
        }
